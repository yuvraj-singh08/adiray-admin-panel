...
//     className="focus:bg-white  mr-5 px-6 py-5 rounded-full mb-4 bg-gray-100" /></>
...
// export function AdminProduct(): JSX.Element {
...
//         fetch(`http://localhost:8080/api/category/product/${categoryId}`)
//             .then(res => res.json())
//             .then((data: Category) => { console.log(data.products); setData(data) });
//     }, [])
...
//                 {
//                     data &&
//                     <div className="font-medium text-3xl text-center mt-40">{data.name}</div>
//                 }
...
//                         data && data.products.map((item: Product, index: number) => {
//                             return (
//                                 <CustomCard name={item.name} imageUrl={item.imageUrl} categoryId={item._id} key={index} />
//                             )
//                         })
//                     }

//                     <CreateProduct categoryId={categoryId} refresh={refresh} visible={modalVisible} setVisible={setModalVisible} />
//                 </div>
//             </div>
//         </>
//     );
